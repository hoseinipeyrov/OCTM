...
using OCTM.Infra.CrossCutting.Identity.Extensions;
using OCTM.Infra.CrossCutting.Identity.Models;
using OCTM.Infra.CrossCutting.Identity.Models.ManageViewModels;
using OCTM.Infra.CrossCutting.Identity.Services;
using OCTM.UI.Web.Extensions;
    ...
    public class ManageController : Controller
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("OCTM Project"),
